...
const DragDropFileUpload = ({
  ...
  // Render a success indicator for processed documents (without button)
  const renderSuccessIndicator = () => {
    if (documentProcessed && !showProcessButton) {
      return (
        <div className="document-processed-indicator">
  ...
  return (
    <div className={`drag-drop-file-upload ${documentProcessed ? 'document-processed' : ''}`}>
      {!selectedFile ? (
        <div 
        ...
        <div className="selected-file-container">
          <div className={`file-preview-container ${invalid ? 'is-invalid' : ''} ${documentProcessed ? 'processed' : ''}`}>
